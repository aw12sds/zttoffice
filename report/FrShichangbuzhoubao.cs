...
{
    public partial class FrShichangbuzhoubao : Office2007Form
    {
        public FrShichangbuzhoubao()
        {
        ...
        private void FrShichangbuzhoubao_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridViewX5.Rows.Count > 11)
            {
            ...
            if (dataGridViewX5.Rows.Count == 1)
            {
            ...
            if (dataGridViewX1.Rows.Count > 1 && dataGridViewX1.Rows.Count < 12)
            {
                ...
                if (dataGridViewX1.Rows[0].Cells["存在问题"].Value == null)
                {
                    MessageBox.Show("第一条存在问题必须输入！");
                    return;
                }

                if (dataGridViewX1.Rows[0].Cells["改善措施"].Value == null)
                {
                    MessageBox.Show("第一条改善措施必须输入！");
                    return;
                }

                string a = dataGridViewX1.Rows[0].Cells["存在问题"].Value.ToString();
                ...
                string b = dataGridViewX1.Rows[0].Cells["改善措施"].Value.ToString();
            ...
            if (dataGridViewX3.Rows.Count > 1 && dataGridViewX3.Rows.Count < 12)
            {
                ...
                if (dataGridViewX3.Rows[0].Cells["客户需求情况"].Value == null)
                {
                ...
                string a = dataGridViewX3.Rows[0].Cells["客户需求情况"].Value.ToString();
            ...
            if (dataGridViewX4.Rows.Count > 1 && dataGridViewX4.Rows.Count < 12)
            {
                ...
                if (dataGridViewX4.Rows[0].Cells["计划项目推进"].Value == null)
                {
                ...
                string a = dataGridViewX4.Rows[0].Cells["计划项目推进"].Value.ToString();
            ...
            if (dataGridViewX5.Rows.Count > 1 && dataGridViewX5.Rows.Count < 12)
            {

                if (dataGridViewX5.Rows[0].Cells["管理工作规划"].Value == null)
                {
                    MessageBox.Show("第一条管理工作规划必须输入！");
                    return;
                }

                string a = dataGridViewX5.Rows[0].Cells["管理工作规划"].Value.ToString();
            ...
            if (MessageBox.Show("确认提交吗？", "软件提示", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
            {
                ...
                {
                    if (dataGridViewX1.Rows[i].Cells["存在问题"].Value == null)
                    {
                        dr1["存在问题" + (i + 1)] = "";
                    }
                    if (dataGridViewX1.Rows[i].Cells["存在问题"].Value != null)
                    {
                        dr1["存在问题" + (i + 1)] = dataGridViewX1.Rows[i].Cells["存在问题"].Value.ToString();
                    }
                    if (dataGridViewX1.Rows[i].Cells["改善措施"].Value == null)
                    {
                        dr1["改善措施" + (i + 1)] = "";
                    }
                    if (dataGridViewX1.Rows[i].Cells["改善措施"].Value != null)
                    {
                        dr1["改善措施" + (i + 1)] = dataGridViewX1.Rows[i].Cells["改善措施"].Value.ToString();
                    }
                ...
                {
                    if (dataGridViewX3.Rows[i].Cells["客户需求情况"].Value == null)
                    {
                        dr1["客户需求情况" + (i + 1)] = "";
                    }
                    if (dataGridViewX3.Rows[i].Cells["客户需求情况"].Value != null)
                    {
                        dr1["客户需求情况" + (i + 1)] = dataGridViewX3.Rows[i].Cells["客户需求情况"].Value.ToString();
                    }
                ...
                {
                    if (dataGridViewX4.Rows[i].Cells["计划项目推进"].Value == null)
                    {
                        dr1["计划项目推进" + (i + 1)] = "";
                    }
                    if (dataGridViewX4.Rows[i].Cells["计划项目推进"].Value != null)
                    {
                        dr1["计划项目推进" + (i + 1)] = dataGridViewX4.Rows[i].Cells["计划项目推进"].Value.ToString();
                    }
                ...
                {
                    if (dataGridViewX5.Rows[i].Cells["管理工作规划"].Value == null)
                    {
                        dr1["管理工作规划" + (i + 1)] = "";
                    }
                    ...
                    if (dataGridViewX5.Rows[i].Cells["管理工作规划"].Value != null)
                    {
                        dr1["管理工作规划" + (i + 1)] = dataGridViewX5.Rows[i].Cells["管理工作规划"].Value.ToString();
                    }
