...
{
    public partial class Frchanpinshiyebuzhoubao1 : Form
    {
        public Frchanpinshiyebuzhoubao1()
        {
            InitializeComponent();
        }
        ...
        private void Frchanpinshiyebuzhoubao1_Load(object sender, EventArgs e)
        {
            ...
            string sql2 = "select 申请人,职务,调休原因 from workflow ";
