...
{
    public partial class FrZhoubao : Office2007Form
    {
        public FrZhoubao()
        {
        ...
        private void FrZhoubao_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (zhonglei == "周报")
            {
                ...
                if (dataGridViewX5.Rows.Count > 1 && dataGridViewX5.Rows.Count < 12)
                {
                    ...
                    if (dataGridViewX5.Rows[0].Cells["规划情况2"].Value == null)
                    {
                        MessageBox.Show("第一条下阶段内容必须大于十个字符！");
                        return;
                    }
                    
                    string a = dataGridViewX5.Rows[0].Cells["规划情况2"].Value.ToString();
                    int changdu = a.Length;
                    if (changdu < 10)
                    {
                        MessageBox.Show("第一条下阶段内容必须大于十个字符！");
                ...
                if (MessageBox.Show("确认提交吗？", "软件提示", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
                {
                    ...
                    {
                        if (dataGridViewX5.Rows[i].Cells["规划情况2"].Value == null)
                        {
                            dr1["下阶段" + (i + 1)] = "";
                        }
                        ...
                        if (dataGridViewX5.Rows[i].Cells["规划情况2"].Value != null)
                        {
                            dr1["下阶段" + (i + 1)] = dataGridViewX5.Rows[i].Cells["规划情况2"].Value.ToString();
                        }
                    ...
                    for (int i = 0; i < dataGridViewX4.Rows.Count - 1; i++)
                    {
                        ...
                        if (dataGridViewX4.Rows[i].Cells["规划情况"].Value != null)
                        {
                            dr1["分析" + (i + 1)] = dataGridViewX4.Rows[i].Cells["规划情况"].Value.ToString();
                        }
        ...
        private void dataGridViewX5_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            if (e.ColumnIndex < 0 && e.RowIndex >= 0)
            {
                e.Paint(e.ClipBounds, DataGridViewPaintParts.All);
